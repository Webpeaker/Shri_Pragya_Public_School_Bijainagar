...
values
('home', 'Shri Pragya Public School', 'Home', jsonb_build_object('paragraphs', jsonb_build_array('Nurturing minds and building futures through knowledge, discipline and values.')), true, 0),
...
('academic-calendar', 'Result', 'Academics', jsonb_build_object('paragraphs', jsonb_build_array('Our students continue to make the school proud through dedicated effort, consistent guidance and excellent academic performance.')), true, 15),
...
('house-system', 'House System', 'Activities', jsonb_build_object('paragraphs', jsonb_build_array('The house system builds leadership, team spirit, healthy competition and responsibility among students.'), 'houses', jsonb_build_array(jsonb_build_array('Blue House', '#1d4ed8'), jsonb_build_array('Green House', '#15803d'), jsonb_build_array('Red House', '#b91c1c'), jsonb_build_array('Yellow House', '#ca8a04'))), true, 30),
...
('careers', 'Careers', 'Careers', jsonb_build_object('paragraphs', jsonb_build_array('We welcome passionate educators who believe in discipline, care and student-centered learning.')), true, 34),
